%% PRÁCTICA 13.12. Análisis tiempo‑frecuencia mediante la transformada Superlets FASLT
...
fois = 1:0.5:250;  %vector buffer para el rango de las frecuencias 
srord= [1, 30];     %vector de ciclos 
tic
