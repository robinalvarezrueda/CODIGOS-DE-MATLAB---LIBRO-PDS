...
j=1;
   for i=1:1:25
    ...
    if  extraccion == 1 %'si'
        [gp1,gp2,gp3,gp4,gp5,gp6,gp7,gp8]=extraccion_senial_1(c1,c2,c3,c4,c5,c6,c7,c8,i);
...
j=1;
   for i=1:1:25
    ...
    % AREA BAJO LA CURVA
            [total_1,total_2,total_3,total_4,total_5,total_6,total_7,total_8] = area(Pn1,Pn2,Pn3,Pn4,Pn5,Pn6,Pn7,Pn8);% con rectificacion y suavizado de curvas
