%% PRÁCTICA 13.3. Análisis tiempo‑frecuencia completo de una señal multicomponente
...
Fs=10*f6; % Fs respecto de la f5 que es la más exigente 
Ts=1/Fs;
...
figure
tic % Iniciar conteo para medición de carga computacional
spectrogram(xn,window_RF,noverlap_RF,nFFT_ventana_RF,Fs,'yaxis');
title('ESPECTROGRAMA SIN PARÁMETROS DE SALIDA');
axis([0 4 0 100])
toc  % Finalizar conteo para medición de carga computacional
